...
public class E2Eflow extends BaseTest {
    ...
    public void compareDataBetweenUserAndAdmin() {
        ...
        cartPage.clickOnContitnueToShippingButton();
...
//        String expectedProductTotalPriceUser = PropertiesHelper.getData("PRODUCT_TOTAL_PRICE_USER", "src/test/resources/configs/savedData.properties");
        ...
        orderDetailPage.openOderDetailPage();
    ...
    @Test(priority = 1, dataProvider = "dataAddProductsAndQuantity", dataProviderClass = DataProvidersAddProducts.class)
